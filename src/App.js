...
><h2> WELCOME TO BGM GAME
   
</h2>
<img src="/homeimage.png" alt="Home" className="home-img"/>
</div>;

const About = () => <div className="about-content">
  <div className="game-heading"><h1 >ABOUT BGM GAME</h1></div>
<p>Welcome to BGM GAME, the flagship brand of BGM GAME PRIVATE LIMITED, 
  where skill, strategy, and precision take center stage! We are a platform dedicated to
   ...
   <p>At BGM GAME, our mission is to create a platform that celebrates skill, strategy, and fair play. We aim to provide 
    ...
    <h2>What We Offer</h2>
    <p>
    <b>Diverse Markets:</b> We provide access to 15 exciting markets, including SILVER CITY, LONDON BAZAR, DEV DARSHAN, and more.
    <b>Skill-Based Games:</b> Our platform features games like JODI, HARRAF, MANNUAL, COPY PASTE, and CROSSING.
    <b>Referral Program:</b> Earn rewards for referring friends and family.
    <b>Secure and Transparent:</b> We prioritize user security with strict data protection measures.
    <b>Responsible Gaming:</b> Encouraging fair play and responsible participation.
    </p>
    <h2>Customer Support
    </h2>
    <p>
    We are dedicated to providing exceptional customer support. For assistance, contact us at <b>support@bgmgame.in.</b>
    </p>
    <h2>Contact Us</h2>
    <p>
...
<b>Email ID: </b>support@bgmgame.in
    </p>
    <h2>Join Us Today!</h2>
    <p>
